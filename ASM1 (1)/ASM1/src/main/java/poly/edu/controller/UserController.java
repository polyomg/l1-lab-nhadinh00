...
public class UserController {
    ...
    private boolean isAdmin = true; // Giả sử người dùng đăng nhập có role admin hay không.
    ...
    public String userManagement(Model model, HttpSession session,
        ...
        if (isAdmin == null) {
            isAdmin = false; // Mặc định là false nếu không có thông tin
        }
        ...
        // Pagination and search for staff (if admin)
        if (isAdmin) {
